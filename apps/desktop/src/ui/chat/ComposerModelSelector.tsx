  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <Command
          label="Search models"
          className="rounded-lg bg-transparent [&_[data-slot=command-input-wrapper]]:border-b [&_[data-slot=command-input-wrapper]]:app-border-subtle [&_[data-slot=command-input-wrapper]]:bg-background/60 [&_[data-slot=command-input-wrapper]]:px-3"
        >
