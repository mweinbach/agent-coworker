...
export function QuickChatShell({ init, ready, startupError }: QuickChatShellProps) {
  ...
  return (
    <div className="flex h-screen min-h-0 min-w-0 overflow-hidden bg-transparent p-0 text-foreground">
      <div className="app-surface-overlay flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-[22px] bg-[radial-gradient(circle_at_top,var(--surface-overlay),transparent_52%),linear-gradient(180deg,var(--surface-shell),var(--surface-window))] backdrop-blur-xl ring-1 ring-black/5">
        <div
