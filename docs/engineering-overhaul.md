...
| 03 | [Provider descriptors and static catalog](../src/providers/modelAdapter.ts) | **KEEP** provider-specific wire factories, platform restrictions, aliases, and static defaults. **DELETE** duplicated API-key lookup branches in favor of the shared resolver. No speculative model, price, dependency, or vendor refresh. | [Tests](../test/providers/) |
