...
| [src/runtime/googleInteractionsModel.ts](../src/runtime/googleInteractionsModel.ts) | `__internal` | Unused object exposing the private model table; live model resolution stays. [runtime.core.test.ts](../test/runtime/google-native/runtime.core.test.ts). |
