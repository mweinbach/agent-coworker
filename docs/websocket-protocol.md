...
- The current managed runtime pin is Codex app-server `0.152.1`. Release assets are SHA-256 verified for supported macOS, Linux, and Windows architectures before installation or execution.
