...
const OPENCODE_MODEL_SPECS: Record<OpenCodeModelId, OpenCodeModelSpec> = {
  "claude-opus-4-8": { id: "claude-opus-4-8", name: "Claude Opus 4.8", reasoning: true, input: ["text", "image"], contextWindow: 1000000, maxTokens: 128000 },
  "claude-opus-4-7": { id: "claude-opus-4-7", name: "Claude Opus 4.7", reasoning: true, input: ["text", "image"], contextWindow: 1000000, maxTokens: 128000 },
  "claude-opus-4-6": { id: "claude-opus-4-6", name: "Claude Opus 4.6", reasoning: true, input: ["text", "image"], contextWindow: 1000000, maxTokens: 128000 },
  "claude-opus-4-5": { id: "claude-opus-4-5", name: "Claude Opus 4.5", reasoning: true, input: ["text", "image"], contextWindow: 200000, maxTokens: 64000 },
  "claude-opus-4-1": { id: "claude-opus-4-1", name: "Claude Opus 4.1", reasoning: true, input: ["text", "image"], contextWindow: 200000, maxTokens: 32000 },
  "claude-sonnet-4-6": { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", reasoning: true, input: ["text", "image"], contextWindow: 1000000, maxTokens: 64000 },
  "claude-sonnet-4-5": { id: "claude-sonnet-4-5", name: "Claude Sonnet 4.5", reasoning: true, input: ["text", "image"], contextWindow: 1000000, maxTokens: 64000 },
  "claude-sonnet-4": { id: "claude-sonnet-4", name: "Claude Sonnet 4", reasoning: true, input: ["text", "image"], contextWindow: 1000000, maxTokens: 64000 },
  "claude-haiku-4-5": { id: "claude-haiku-4-5", name: "Claude Haiku 4.5", reasoning: true, input: ["text", "image"], contextWindow: 200000, maxTokens: 64000 },
  "gemini-3.5-flash": { id: "gemini-3.5-flash", name: "Gemini 3.5 Flash", reasoning: true, input: ["text", "image"], contextWindow: 1048576, maxTokens: 65536 },
  "gemini-3.1-pro": { id: "gemini-3.1-pro", name: "Gemini 3.1 Pro Preview", reasoning: true, input: ["text", "image"], contextWindow: 1048576, maxTokens: 65536 },
  "gemini-3-flash": { id: "gemini-3-flash", name: "Gemini 3 Flash", reasoning: true, input: ["text", "image"], contextWindow: 1048576, maxTokens: 65536 },
  "gpt-5.5": { id: "gpt-5.5", name: "GPT-5.5", reasoning: true, input: ["text", "image"], contextWindow: 1050000, maxTokens: 128000 },
  "gpt-5.5-pro": { id: "gpt-5.5-pro", name: "GPT-5.5 Pro", reasoning: true, input: ["text", "image"], contextWindow: 1050000, maxTokens: 128000 },
  "gpt-5.4": { id: "gpt-5.4", name: "GPT-5.4", reasoning: true, input: ["text", "image"], contextWindow: 1050000, maxTokens: 128000 },
  ...
  "gpt-5.3-codex-spark": { id: "gpt-5.3-codex-spark", name: "GPT-5.3 Codex Spark", reasoning: true, input: ["text"], contextWindow: 128000, maxTokens: 128000 },
  ...
  "gpt-5.2-codex": { id: "gpt-5.2-codex", name: "GPT-5.2 Codex", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "gpt-5.1": { id: "gpt-5.1", name: "GPT-5.1", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "gpt-5.1-codex-max": { id: "gpt-5.1-codex-max", name: "GPT-5.1 Codex Max", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "gpt-5.1-codex": { id: "gpt-5.1-codex", name: "GPT-5.1 Codex", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "gpt-5.1-codex-mini": { id: "gpt-5.1-codex-mini", name: "GPT-5.1 Codex Mini", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "gpt-5": { id: "gpt-5", name: "GPT-5", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "gpt-5-codex": { id: "gpt-5-codex", name: "GPT-5 Codex", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "gpt-5-nano": { id: "gpt-5-nano", name: "GPT-5 Nano", reasoning: true, input: ["text", "image"], contextWindow: 400000, maxTokens: 128000 },
  "grok-build-0.1": { id: "grok-build-0.1", name: "Grok Build 0.1", reasoning: true, input: ["text", "image"], contextWindow: 256000, maxTokens: 256000 },
  ...
  "glm-5.1": { id: "glm-5.1", name: "GLM-5.1", reasoning: true, input: ["text"], contextWindow: 204800, maxTokens: 131072 },
  "glm-5": { id: "glm-5", name: "GLM-5", reasoning: true, input: ["text"], contextWindow: 204800, maxTokens: 131072 },
  "minimax-m2.7": { id: "minimax-m2.7", name: "MiniMax M2.7", reasoning: true, input: ["text"], contextWindow: 204800, maxTokens: 131072 },
  "minimax-m2.5": { id: "minimax-m2.5", name: "MiniMax M2.5", reasoning: true, input: ["text"], contextWindow: 204800, maxTokens: 131072 },
  "kimi-k2.6": { id: "kimi-k2.6", name: "Kimi K2.6", reasoning: true, input: ["text", "image"], contextWindow: 262144, maxTokens: 65536 },
  "kimi-k2.5": { id: "kimi-k2.5", name: "Kimi K2.5", reasoning: true, input: ["text", "image"], contextWindow: 262144, maxTokens: 65536 },
  "qwen3.6-plus": { id: "qwen3.6-plus", name: "Qwen3.6 Plus", reasoning: true, input: ["text", "image"], contextWindow: 262144, maxTokens: 65536 },
  "qwen3.5-plus": { id: "qwen3.5-plus", name: "Qwen3.5 Plus", reasoning: true, input: ["text", "image"], contextWindow: 262144, maxTokens: 65536 },
  "big-pickle": { id: "big-pickle", name: "Big Pickle", reasoning: true, input: ["text"], contextWindow: 200000, maxTokens: 32000 },
  "deepseek-v4-flash-free": { id: "deepseek-v4-flash-free", name: "DeepSeek V4 Flash Free", reasoning: true, input: ["text"], contextWindow: 200000, maxTokens: 128000 },
  "mimo-v2.5-free": { id: "mimo-v2.5-free", name: "MiMo V2.5 Free", reasoning: true, input: ["text", "image"], contextWindow: 200000, maxTokens: 32000 },
  "qwen3.6-plus-free": { id: "qwen3.6-plus-free", name: "Qwen3.6 Plus Free", reasoning: true, input: ["text", "image"], contextWindow: 262144, maxTokens: 65536 },
  "minimax-m3-free": { id: "minimax-m3-free", name: "MiniMax M3 Free", reasoning: true, input: ["text", "image"], contextWindow: 200000, maxTokens: 32000 },
  "nemotron-3-ultra-free": { id: "nemotron-3-ultra-free", name: "Nemotron 3 Ultra Free", reasoning: true, input: ["text"], contextWindow: 1000000, maxTokens: 128000 },
  "north-mini-code-free": { id: "north-mini-code-free", name: "North Mini Code Free", reasoning: true, input: ["text"], contextWindow: 262144, maxTokens: 65536 },
  "minimax-m3": { id: "minimax-m3", name: "MiniMax M3", reasoning: true, input: ["text", "image"], contextWindow: 512000, maxTokens: 131072 },
  ...
  "mimo-v2-pro": { id: "mimo-v2-pro", name: "MiMo V2 Pro", reasoning: true, input: ["text"], contextWindow: 1048576, maxTokens: 128000 },
  "mimo-v2-omni": { id: "mimo-v2-omni", name: "MiMo V2 Omni", reasoning: true, input: ["text", "image"], contextWindow: 262144, maxTokens: 128000 },
  ...
  "hy3-preview": { id: "hy3-preview", name: "Hy3 Preview", reasoning: true, input: ["text"], contextWindow: 262144, maxTokens: 65536 },
};
