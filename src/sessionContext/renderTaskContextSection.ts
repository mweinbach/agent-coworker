...
export function renderTaskContextSection(context: TaskContextSnapshot | null | undefined): string {
  ...
  const lines = [
    ...
    "Use the taskUpdate tool for plans, work-item state, decisions, semantic progress, blockers, durable input requests, artifacts, additional task threads, and completion proposals.",
