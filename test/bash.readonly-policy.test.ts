...
describe("bash read-only shell policy", () => {
  ...
  test("blocks obvious project-mutating commands", () => {
    const blockedCommands = [
      ...
      ["Remove-Item blocked.txt", "filesystem mutation command"],
      ['New-Item -ItemType File "blocked.txt"', "filesystem mutation command"],
      ["Copy-Item source.txt blocked.txt", "filesystem mutation command"],
      ["Move-Item source.txt blocked.txt", "filesystem mutation command"],
      ['Set-Content "blocked.txt" "hello"', "filesystem mutation command"],
      ['pwsh -Command "Remove-Item blocked.txt"', "filesystem mutation command"],
      ['powershell -Command "Set-Content blocked.txt hello"', "filesystem mutation command"],
