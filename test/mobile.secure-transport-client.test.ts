...
describe("mobile secure transport client", () => {
  ...
  test("surfaces denied desktop permissions with actionable Remote Access guidance", async () => {
    ...
    await expect(client.sendPlaintext('{"id":1,"method":"thread/list"}')).rejects.toThrow(
